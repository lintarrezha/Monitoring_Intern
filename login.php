...
<head>
    ...
    <!-- Login CSS -->
    <link rel="stylesheet" href="template/login/css/login.css" />
    <!-- Google Font Roboto -->
...
<body>
    <div class="container rounded shadow-lg px-4 py-5 mt-5 bg-white" style="max-width: 500px">
        <img src="apps/pengaturan/logo/<?php echo $logo; ?>" alt="Logo" class="d-block mx-auto" style="max-height: 120px; margin-bottom: 10px;">
        <h5 class="text-center mb-2">Monitoring Kegiatan dan Presensi Magang</h5>
        <h5 class="text-center mb-4">Dinas Sosial Kota Batu</h5>
        <div class="login-body">
            <div class="welcome-text">
                <p>Silakan login untuk melakukan monitoring kegiatan dan presensi magang</p>
            </div>
