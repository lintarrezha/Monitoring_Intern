...
<body>
    <nav class="navbar navbar-custom navbar-fixed-top bg-info" role="navigation">
        <div class="container-fluid"><!-- container-fluid -->
            <div class="navbar-header">
                ...
                <span class="navbar-brand" href="#">MONITORING KEGIATAN MAGANG</span>
            </div>
        </div><!-- /.container-fluid -->
    </nav>
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <!-- Menu Beranda -->
        <ul class="nav menu">
            <li><a href='index.php?page=beranda'><em class='fa fa-home' style="margin: 7px;">&nbsp;</em>Beranda</a></li>
            <!-- Menu Beranda -->
            <!-- Menu Admin -->
            <?php if ($_SESSION["level"] == "Admin" or $_SESSION['level'] == 'admin'): ?>
                <li><a href="index.php?page=mahasiswa" id="mahasiswa"><em class="fa fa-users" style="margin: 7px;">&nbsp;</em>Data Mahasiswa</a></li>
                <li><a href="index.php?page=data_absensi" id="data_absensi"><em class="fa fa-calendar" style="margin: 7px;">&nbsp;</em>Data Presensi</a></li>
                <li><a href="index.php?page=data_kegiatan" id="kegiatan"><em class="fa fa-book" style="margin: 7px;">&nbsp;</em>Data Kegiatan</a></li>
                <li><a href="index.php?page=admin" id="admin"><em class="fa fa-user" style="margin: 7px;">&nbsp;</em>Administrator</a></li>
                <li><a href="index.php?page=pengaturan" id="pengaturan"><em class="fa fa-gear" style="margin: 7px;">&nbsp;</em>Pengaturan</a></li>
            <?php endif; ?>
            <!-- Menu Admin -->
            <!-- Menu Mahasiswa -->
            <?php if ($_SESSION["level"] == "Mahasiswa" or $_SESSION["level"] == "mahasiswa"): ?>
                <li><a href="index.php?page=absen"><em class="fa fa-calendar-check-o" style="margin: 7px;">&nbsp;</em>Presensi</a></li>
                <li><a href="index.php?page=riwayat"><em class="fa fa-history" style="margin: 7px;">&nbsp;</em>Riwayat Presensi</a></li>
                <li><a href="index.php?page=kegiatan"><em class="fa fa-book" style="margin: 7px;">&nbsp;</em>Kegiatan Harian</a></li>
                <li><a href="index.php?page=profil"><em class="fa fa-user-circle-o" style="margin: 7px;">&nbsp;</em>Profil</a></li>
            <?php endif; ?>
            <!-- Menu Mahasiswa -->
            <!-- Menu Keluar -->
            <li><a href="logout.php" id="keluar"><em class="fa fa-sign-out" style="margin: 7px;">&nbsp;</em>Keluar</a></li>
        </ul>
        <!-- Menu Keluar -->
    </div>
    <!-- Side Bar Navigation -->
