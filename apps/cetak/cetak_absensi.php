<?php
    ...
    $pdf->SetFont('Arial','B',10); // Set font ke Bold untuk label
    $pdf->Cell(30,6,'Nama ',0,0,);
    $pdf->SetFont('Arial','',10); // Set font kembali ke Normal untuk isinya
    ...
    $pdf->SetX($leftX);
    $pdf->Cell(10,0,'Pembimbing Lapangan',0,0,'C');
    
    // Tanda tangan pembimbing (kanan)
    $pdf->SetX($rightX);
    $pdf->Cell(50,0,'Dosen Pembimbing Magang',0,1,'C');
