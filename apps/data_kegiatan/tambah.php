    ...
    if (isset($_POST['simpan_kegiatan'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($time_akhir <= $time_awal) {
                header("Location:../../index.php?page=data_kegiatan&tambah=invalid_time");
                exit;
            }
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="time" name="waktu_awal" id="waktu_awal" class="form-control" value="" required>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                <label>Waktu Akhir Kegiatan:</label>
                <input type="time" name="waktu_akhir" id="waktu_akhir" class="form-control" value="" required>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="form-group">
                <label>Kegiatan:</label>
                <input type="text" name="kegiatan" id="kegiatan" class="form-control" value="" required placeholder="Masukkan Kegiatan Harian">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                <br>
                <button type="submit" name="simpan_kegiatan" id="simpan_kegiatan" class="btn btn-success" ><i class="fa fa-check"></i> Simpan</button>
                <button type="reset" class="btn btn-warning" ><i class="fa fa-trash"></i> Clear</button>
            </div>
        </div>
    </div>
</form>