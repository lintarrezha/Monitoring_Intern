            ...
            <?php
                ...
                if (isset($_GET['mulai'])) {
                    if ($_GET['mulai']=='berhasil'){
                        ...
                        echo"<div class='alert alert-warning'><strong>Maaf!</strong> Belum Melakukan Presensi atau Lewat dari Batas Presensi</div>";
                    }
                }
            ?>
                ...
                <div class="row">
                    ...
                    <tr>
                        <td>
                            <button id_mahasiswa="<?php echo $id_mahasiswa; ?>" id="tombol_absensi" class="tombol_periode mulai_absensi btn btn-success btn-circle"><i class="fa fa-clock-o"></i>  Presensi</button>
                        </td>
                    </tr>
                    </tbody>
                    </table>
